...
@RestController
@RequestMapping("{shelterDesignation}/animal_ownership")
public class AnimalOwnershipController {
    ...
    public ResponseEntity<AnimalOwnershipDto> createAnimalOwnership(@RequestBody @Valid AnimalOwnershipDto animalOwnershipDto,
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(animalOwnershipService.createAnimalOwnership(animalOwnershipDto, shelterDesignation));
    }
    ...
    public ResponseEntity<AnimalOwnershipDto> readAnimalOwnership(@Parameter(description = "AnimalOwnership id") @PathVariable Long id,
                                                                  @PathVariable String shelterDesignation) {
        return ResponseEntity.ok(animalOwnershipService.readAnimalOwnership(id, shelterDesignation));
    }
    ...
    public ResponseEntity<AnimalOwnershipDto> updateAnimalOwnership(@RequestBody @Valid AnimalOwnershipDto animalOwnershipDto,
                                                                    @PathVariable String shelterDesignation) {
        return ResponseEntity.ok(animalOwnershipService.updateAnimalOwnership(animalOwnershipDto, shelterDesignation));
    }
    ...
    public ResponseEntity<AnimalOwnershipDto> deleteAnimalOwnership(@Parameter(description = "AnimalOwnership id") @PathVariable Long id,
                                                                    @PathVariable String shelterDesignation) {
        return ResponseEntity.ok(animalOwnershipService.deleteAnimalOwnership(id, shelterDesignation));
    }
    ...
    public ResponseEntity<Collection<AnimalOwnershipDto>> getAllAnimalOwnerships(
            @PathVariable String shelterDesignation) {
        return ResponseEntity.ok(animalOwnershipService.getAll(shelterDesignation));
    }
}

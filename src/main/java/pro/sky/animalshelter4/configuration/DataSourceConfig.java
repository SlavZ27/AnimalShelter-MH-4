...
public class DataSourceConfig {
    ...
    @Autowired
    public DataSource dataSource(DataSource dataSource0, DataSource dataSource1, DataSource dataSource2) {
        ...
        dataSource.initDataSources(dataSource0, dataSource1, dataSource2);
    ...
    public DataSource dataSource0() {
        ...
        dataSource.setDriverClassName(env.getProperty("spring.datasource.driver-class-name.0"));
        dataSource.setUrl(env.getProperty("spring.datasource.url.0"));
        dataSource.setUsername(env.getProperty("spring.datasource.username.0"));
        dataSource.setPassword(env.getProperty("spring.datasource.password.0"));

        log.info("## DataSource0: " + dataSource);
        return dataSource;
    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(DataSource dataSource, JpaProperties jpaProperties) {
        ...
        entityManagerFactoryBean.setPackagesToScan("pro.sky.animalshelter4.entity");

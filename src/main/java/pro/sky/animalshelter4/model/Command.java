...
public enum Command {
    ...
    MENU_BACK1(99, "/MENU_BACK1", "BACK",true, true, true, true, 1, new String[]{"CAT", "DOG"}),
    MENU_BACK2(99, "/MENU_BACK2", "BACK",true, true, true, true, 2, new String[]{"CAT", "DOG"}),
    MENU_BACK3(99, "/MENU_BACK3", "BACK",true, true, true, true, 3, new String[]{"CAT", "DOG"}),
    MENU_INFO_SHELTER(1, "/MENU_INFO_SHELTER", "Shelter",true, true, true, true, 0, new String[]{"CAT", "DOG"}),
    MENU_INFO_ANIMAL(2, "/MENU_INFO_ANIMAL", "Animal",true, true, true, true, 0, new String[]{"CAT", "DOG"}),
    MENU_ACTION(3, "/MENU_ACTION", "ACTION",true, true, true, true, 0, new String[]{"CAT", "DOG"}),
    SET_SHELTER(0, "/SET_SHELTER", "Set shelter", false, true, true, true, 0, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by the client to create a callback request
     */
    CALL_REQUEST(4, "/CALL_REQUEST", "Ask to call back", true, true, true, false, 0, new String[]{"CAT", "DOG"}),
    CHANGE_SHELTER(5, "/CHANGE_SHELTER", "Change shelter", true, true, true, true, 0, new String[]{"CAT", "DOG"}),
    /**
     * The command is used to call information about the shelter
     */
    INFO(6, "/info", "About", true, true, true, true, 1, new String[]{"CAT", "DOG"}),
    /**
     * The command is used to call information about how to take an animal from a shelter
     */
    HOW(7, "/HOW", "how?", true, true, true, true, 1, new String[]{"CAT", "DOG"}),
    /**
     ...
     */
    INFO_LIST_DOCUMENTS(8, "/INFO_LIST_DOCUMENTS", "Documents", true, true, true, true, 1, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by all users to get information about why they may refuse to take the dog home
     */
    INFO_REFUSE(9, "/INFO_REFUSE", "Refuse", true, true, true, true, 1, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by all users to get information about what not to do with themselves
     */
    INFO_GET_ANIMAL(10, "/INFO_GET_ANIMAL", "Get animal", true, true, true, true, 1, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by all users to get information about dogs with disabilities
     */
    INFO_DISABILITIES(11, "/INFO_DISABILITIES", "Disabilities", true, true, true, true, 2, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by all users to get information on how to arrange a place for an adult dog to live
     */
    INFO_RECOMMEND_HOME_ANIMAL(12, "/INFO_RECOMMEND_HOME_ANIMAL", "Animal in home", true, true, true, true, 2, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by all users to get information on how to arrange a place for a small dog to live
     */
    INFO_RECOMMEND_HOME_ANIMAL_SMALL(13, "/INFO_RECOMMEND_HOME_ANIMAL_SMALL", "Small animal in home", true, true, true, true, 2, new String[]{"CAT", "DOG"}),
    /**
     *  The command is used by all users to get Tips from a dog handler on primary communication with a dog
     */
    INFO_TIPS(14, "/INFO_TIPS", "Tips", true, true, true, true, 2, new String[]{"DOG"}),
    /**
     * The command is used by all users to get information about the rules of transportation of animals
     */
    INFO_TRANSPORTATION(15, "/INFO_TRANSPORTATION", "Transportation", true, true, true, true, 2, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by all users to get info about why do you need a dog handler
     */
    INFO_NEED_HANDLER(16, "/INFO_NEED_HANDLER", "Handler", true, true, true, true, 2, new String[]{"DOG"}),
    /**
     * The command is used by a volunteer to call up a list of users who created a callback request
     */
    CALL_CLIENT(17, "/CALL_CLIENT", "Call client", true, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by a volunteer to close a call to the list of users who created a callback request
     */
    CLOSE_CALL_REQUEST(18, "/CLOSE_CALL_REQUEST", "Close req", false, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by a client and owner to changes number phone
     */
    CHANGE_PHONE(19, "/CHANGE_PHONE", "Change phone", true, true, true, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by a volunteer to add an animal
     */
    ADD_ANIMAL(20, "/ADD_ANIMAL", "Add animal", true, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The team is used by a volunteer to add an animal to a client's property
     */
    CREATE_OWNERSHIP(21, "/CREATE_OWNERSHIP", "Own", true, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by the owner to create a report
     */
    REPORT(22, "/REPORT", "Report", true, false, true, false, 3, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by the volunteer to view the report
     */
    VIEW_REPORT(23, "/VIEW_REPORT", "Reports", true, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The team is used by the volunteer to approve the report
     */
    APPROVE_REPORT(24, "/APPROVE_REPORT", "Approve reports", false, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The command is used by the volunteer to view ownership
     */
    VIEW_OWNERSHIP(25, "/VIEW_OWNERSHIP", "View_ownership", true, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The team is used by a volunteer to assert ownership
     */
    APPROVE_OWNERSHIP(26, "/APPROVE_OWNERSHIP", "Approve_ownership", false, false, false, true, 3, new String[]{"CAT", "DOG"}),
    /**
     * The team is used by a volunteer to extend temporary ownership
     */
    EXTEND_TRIAL(27, "/EXTEND_TRIAL", "Extend trial", false, false, false, true, 3, new String[]{"CAT", "DOG"}),

...
public enum Command {
    ...
    SET_SHELTER(1, "/SET_SHELTER", "Set shelter", true, true, true, true, 0, new String[]{"CAT", "DOG"}),
    CHANGE_SHELTER(1, "/CHANGE_SHELTER", "Change shelter", true, true, true, true, 0, new String[]{"CAT", "DOG"}),
